...
import { ELITE_FLUTED_WALL_PANELS, ELITE_FLUTED_COLLECTION_META } from './eliteFlutedPanelsData';
...
export { ELITE_FLUTED_WALL_PANELS, ELITE_FLUTED_COLLECTION_META };
